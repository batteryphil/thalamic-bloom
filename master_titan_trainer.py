...
def get_dataloader_for_phase(phase, tokenizer, resume_step=0, seq_len=512):
    ...
    # ── Phase 2, 3 & 3j: Enriched Cognitive Bloom ─────────────────────────
    elif phase in ('2', '3', '3j'):
...
def train():
    ...
    if phase == '1':
        ...
        BASE_LR_CORE  = 3e-6   # Low: cloned arms, preserve Phase 1 backbone features
        BASE_LR_HEAD  = 6e-6   # Moderate: head sees same Blackboard features as Phase 1
    elif phase in ('3', '3j'):
        BASE_LR_CORE  = 5e-6
        BASE_LR_HEAD  = 1e-5
    else:
